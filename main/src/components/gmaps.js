  ...
  renderDeprecatedBehavior() {// Remove when reach 5.0.0
    return (
      <ScriptjsLoader
        ...
        query={{ v: `3.${ AsyncGettingStarted.version }`, libraries: `geometry,drawing,places`, key: "AIzaSyBg2w2-dyqj3Sa8ib3PzmRBeh_2iRxd4xU" }}
        loadingElement={
          <div
            {...this.props}
            style={{
        ...
        googleMapElement={
          <GoogleMap
            ...
            defaultZoom={16}
            defaultCenter={{ lat: 53.793584, lng: -1.540088 }}
